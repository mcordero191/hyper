...
def train_hyper(df,
    ...
    filename = os.path.join(rpath, filename_model)
    
    nn = pinn.restore(filename_mean,
                      include_res_layer=True,
    ...
    ############################################################
    #Traning points
    figname02 = os.path.join(rpath, 'training_winds_%s.png' %suffix)
    figname03 = os.path.join(rpath, 'training_errors_%s.png' %suffix)
    figname04 = os.path.join(rpath, 'training_errors_k_%s.png' %suffix)
    figname05 = os.path.join(rpath, 'training_statistics_%s.png' %suffix)
    figname_P = os.path.join(rpath, 'training_pressure_%s.png' %suffix)
...
if __name__ == '__main__':
    ...
    path = '/Users/mcordero/Data/IAP/VirtualRadar/ICON_+00+70+90/Simone2018'
    path = '/Users/mcordero/Data/IAP/SIMONe/Germany/Simone2018'
    path = '/Users/mcordero/Data/IAP/SIMONe/Argentina/DanielsData'
    
    path = '/Users/mcordero/Data/IAP/SIMONe/Virtual/ICON_20160815/ICON_+00+70+90'
    
    dirname = os.path.dirname( os.path.realpath(path) )
    
    rpath = os.path.join(dirname, 'PINN_xyh_vFNC_5.10n')
    # rpath = os.path.join(dirname, 'tmp')
