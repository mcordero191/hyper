...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--subfolder', dest='subfolder', default="nnRESPINN_16.03", help='subfolder where the neural network model is stored')
    ...
    parser.add_argument('-l', '--log-file', dest='log_file', default=2500, help='select the i-th weights file from the log folder')
